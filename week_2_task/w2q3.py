...
std = int(input('Input the total number of students: '))
size = int(input('Input the group size: '))

total_students = std // size
extra_students = std % size

print("total number of student is",total_students,"and leftover smaller groups are",extra_students)